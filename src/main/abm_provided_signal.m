...
agent_signal_param = 0.2; % str2num(getenv('QCG_STEP_INDEX'))/10; parametr A sygnalu losowego agenta
generator_params = 0.3;
agent_signal_generator = @wfbm_generator; % handler do generatora sygna³u agenta
provided_signal = 1;
...
save(['abm_ar1_p02_j1_a',strrep(num2str(agent_signal_param), '.', ''),'_wfbm_03'],'state','threshold','-v7.3');